		...
		<div class="top-navbar">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <a class="btn btn-success btn-sm" href="Controlador1?accion=addHorarios">Agregar CITA</a>
            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    List<Horarios>list=dao.listar();
                    Iterator<Horarios>iter=list.iterator();
                    Horarios hor=null;
                    while(iter.hasNext()){
                        hor=iter.next();
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><%= hor.getId()%></td>
                        <td><%= hor.getNom()%></td>
                        <td><%= hor.getApe()%></td>
                        <td><%= hor.getFecha()%></td>
                        <td><%= hor.getHora()%></td>
                        <td class="text-center">
                            <a class="btn btn-warning" href="Controlador1?accion=editar&id=<%= hor.getId()%>">Editar</a>
                            <a class="btn btn-danger" href="Controlador1?accion=eliminar&id=<%= hor.getId()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="card" style="min-height: 485px" >
                                ...
                                <br>
                                <br><!-- comment --><!-- comment -->
                                <img src="img/img4.jpg" po height="500px" width="500" style="margin: auto" class="img-responsive"/>     
